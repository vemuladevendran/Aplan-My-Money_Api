const {
  ...
  module.exports = function budgetExpenseRoutes(app) {
    ...
    app.get("/api/v1/budget/expenses/:id", authenticateToken, budgetGetExpenseById);
    app.put("/api/v1/budget/expenses/:id", authenticateToken, budgetUpdateExpense);
    app.delete("/api/v1/budget/expenses/:id", authenticateToken, budgetDeleteExpense);
